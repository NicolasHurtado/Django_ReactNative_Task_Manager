...
export const useAuthStore = create<AuthState>((set, get) => ({
  ...
  logout: async () => {
    // Primero eliminamos los tokens de AsyncStorage
    await AsyncStorage.removeItem(TOKEN_KEY);
    await AsyncStorage.removeItem(USER_KEY);
    
    // Actualizamos el estado de autenticación después de un breve retraso
    // Esto dará tiempo para que se muestre el SplashScreen
