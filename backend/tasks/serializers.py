...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ['id', 'title', 'description', 'start_date', 'due_date', 'completed', 'user', 'created_at', 'updated_at']
        read_only_fields = ['id', 'created_at', 'updated_at']
        extra_kwargs = {
            'title': {'required': True, 'error_messages': {'required': FIELD_REQUIREMENTS['title_required']}},
            'start_date': {'required': True, 'error_messages': {'required': FIELD_REQUIREMENTS['start_date_required']}},
        }
